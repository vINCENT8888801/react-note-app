...
const useContextTopic = () => {
    ...
    return (
        <div className="flex flex-auto flex-col">
            ...
            <Paragraph>Here we have a button that controls the header size of the App. If you move between component, you'll see the size of the header is persistent.</Paragraph>
            <div className="px-2">
