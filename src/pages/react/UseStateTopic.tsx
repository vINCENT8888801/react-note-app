...
const HooksInfo = () => {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <p className="px-4">What are React Hooks?</p>
            <p className="px-4">React Hooks are functions that let us hook into the React state and lifecycle features from function components. React Hooks don't work inside classes.  </p>
            <NoteCodeBlock code={hookDontWorkOnClassComponentCode} />
            <p className="px-4">Hooks also must be run on same order every time it render, so cannot be inside a conditional statement</p>
